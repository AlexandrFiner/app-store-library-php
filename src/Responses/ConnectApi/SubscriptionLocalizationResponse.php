...
/**
 * @link https://developer.apple.com/documentation/appstoreconnectapi/subscriptionlocalizationresponse
 */
class SubscriptionLocalizationResponse extends BaseResponse
{
    use HasDataTrait;
