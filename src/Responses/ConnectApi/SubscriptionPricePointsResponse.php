...
/**
 * @link https://developer.apple.com/documentation/appstoreconnectapi/subscriptionpricepointsresponse
 */
class SubscriptionPricePointsResponse extends BaseResponse
{
    use HasDataTrait;
