...
/**
 * @link https://developer.apple.com/documentation/appstoreconnectapi/subscriptionpricepointequalizationslinkagesresponse
 */
class SubscriptionPricePointEqualizationsLinkagesResponse extends BaseResponse
{
    use HasDataTrait;
